...
class _PatientDetailsScreenState extends State<PatientDetailsScreen>
              ...
              child: Center(
                child: Hero(
                  ...
                  child: Image.network(
                    ...
                    key: ValueKey('viewer_${DateTime.now().millisecondsSinceEpoch}'),
  ...
  Widget _buildPhotoCard() {
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(16),
        side: BorderSide(color: hasPhoto ? Colors.green.shade200 : Colors.grey.shade200, width: 1),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.network(
                      ...
                      fit: BoxFit.cover,
                      // Force network image refresh by adding timestamp
                      key: ValueKey('photo_${DateTime.now().millisecondsSinceEpoch}'),
                      loadingBuilder: (context, child, loadingProgress) {
                        if (loadingProgress == null) return child;
                        return Container(
                          height: 200,
  ...
  Widget _buildIdProofCard() {
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(16),
        side: BorderSide(color: hasIdProof ? Colors.green.shade200 : Colors.grey.shade200, width: 1),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ListTile(
            leading: Container(
              padding: const EdgeInsets.all(8),
              decoration: BoxDecoration(
                color: hasIdProof ? Colors.green.shade100 : Colors.grey.shade100,
                borderRadius: BorderRadius.circular(12),
              ),
              child: Icon(
                Icons.badge,
                color: hasIdProof ? Colors.green.shade600 : Colors.grey.shade400,
                size: 24,
              ),
            ),
            ...
            subtitle: Text(
              ...
              style: TextStyle(
                color: hasIdProof ? Colors.green.shade600 : Colors.grey.shade600,
              ),
            ),
            trailing: Row(
              mainAxisSize: MainAxisSize.min,
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.network(
                      ...
                      fit: BoxFit.cover,
                      // Force network image refresh by adding timestamp
                      key: ValueKey('idproof_${DateTime.now().millisecondsSinceEpoch}'),
                      loadingBuilder: (context, child, loadingProgress) {
                        if (loadingProgress == null) return child;
                        return Container(
                          height: 200,
