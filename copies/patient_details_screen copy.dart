  ...
  Future<void> _loadPatientFiles() async {
    try {
      ...
      if (patient.photo != null && patient.photo!.isNotEmpty) {
        setState(() {
          _photoUrl = _apiService.getFileUrl(patient.photo);
        });
      }

      // Update ID proof URL if available
      if (patient.idProof != null && patient.idProof!.isNotEmpty) {
        setState(() {
          _idProofUrl = _apiService.getFileUrl(patient.idProof);
        });
      }
